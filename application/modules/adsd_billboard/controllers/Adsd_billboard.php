...
class Adsd_billboard extends CI_Controller
{
    var $active_menu = array(
        'active' => 'menu_iklan',
        'sub_active' => 'submenu_adsd_billboard',
    );
    ...
    public function index()
    {
        ...
        //content
        $content['page_title'] = 'Iklan Desktop (BILLBOARD)';
        $content['content_title'] = 'Iklan Desktop (BILLBOARD)';
