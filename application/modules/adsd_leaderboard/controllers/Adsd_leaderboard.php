...
class Adsd_leaderboard extends CI_Controller
{
    var $active_menu = array(
        'active' => 'menu_iklan',
        'sub_active' => 'submenu_adsd_leaderboard',
    );
    ...
    public function index()
    {
        ...
        //content
        $content['page_title'] = 'Iklan Desktop (LEADERBOARD)';
        $content['content_title'] = 'Iklan Desktop (LEADERBOARD)';
