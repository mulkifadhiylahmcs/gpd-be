...
class Setup_pengumuman extends CI_Controller
{
    var $active_menu = array(
        'active' => 'menu_website',
        'sub_active' => 'submenu_setup_pengumuman',
    );
    ...
    public function index()
    {
        ...
        //content
        $content['page_title'] = 'Setup Pengumuman';
        $content['content_title'] = 'Setup Pengumuman';
