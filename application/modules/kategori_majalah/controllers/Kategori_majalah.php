...
class Kategori_majalah extends CI_Controller
{
    var $active_menu = array(
        'active' => 'menu_ols',
        'sub_active' => 'submenu_ols_kategori_majalah',
    );
    ...
    public function index()
    {
        ...
        //content
        $content['page_title'] = 'Kategori Majalah';
        $content['content_title'] = 'Kategori Majalah';
