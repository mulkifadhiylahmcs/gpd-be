...
class Adsd_skycrapper extends CI_Controller
{
    var $active_menu = array(
        'active' => 'menu_iklan',
        'sub_active' => 'submenu_adsd_skycrapper',
    );
    ...
    public function index()
    {
        ...
        //content
        $content['page_title'] = 'Iklan Desktop (SKYCRAPPER)';
        $content['content_title'] = 'Iklan Desktop (SKYCRAPPER)';
