<div class="col s12 m12 l12">
    ...
    <form class="col s12 form_sub" id="form_submit" name="form_submit" enctype="multipart/form-data">
        ...
        <div class="row card card-area">
            ...
            <div class="input-field col s12 m6 l6">
                <input type="text" id="id_province" name="id_province" readonly />
                <label for="id_province" class="active">Provinsi</label>
            </div>
            <div class="input-field col s12 m6 l6">
                <input type="text" id="id_city" name="id_city" readonly />
                <label for="id_city" class="active">Kota/Kabupaten</label>
            </div>
            <div class="input-field col s12 m6 l4">
                <input type="text" id="id_district" name="id_district" readonly />
                <label for="id_district" class="active">Kecamatan</label>
            </div>
            <div class="input-field col s12 m6 l4">
                <input type="text" id="id_subdistrict" name="id_subdistrict" readonly />
                <label for="id_subdistrict" class="active">Kelurahan</label>
            </div>
            <div class="input-field col s12 m6 l4">
                <input type="text" id="id_postalcode" name="id_postalcode" readonly />
            ...
            <div class="input-field col s12 m6 l6">
                <input type="text" id="birth_place" name="birth_place" readonly />
            ...
            <div class="input-field col s12 m6 l4">
                <input type="text" id="is_login" name="is_login" readonly />
                <label for="is_login" class="active">Is Login?</label>
            </div>
            <div class="input-field col s12 m6 l4">
                <input type="text" id="http_cookie" name="http_cookie" readonly />
                <label for="http_cookie" class="active">HTTP Cookie</label>
            </div>
            <div class="input-field col s12 m6 l4">
                <input type="text" id="last_login_ip" name="last_login_ip" readonly />
                <label for="last_login_ip" class="active">Last Login IP</label>
            </div>
        </div>
