    ...
    <form class="col s12 form_sub" id="form_submit" name="form_submit" enctype="multipart/form-data">
        ...
        <div class="row card card-area">
            ...
            <div class="input-field col s12 m6 l6">
                <input type="text" id="id_department" name="id_department" readonly />
                <label for="id_department" class="active">Department</label>
            </div>
            <div class="input-field col s12 m6 l6">
                <input type="text" id="id_division" name="id_division" readonly />
                <label for="id_division" class="active">Division</label>
            </div>
            <div class="input-field col s12 m6 l6">
                <input type="text" id="id_parent" name="id_parent" readonly />
                <label for="id_parent" class="active">Supervisi</label>
            </div>
            <div class="input-field col s12 m6 l6">
