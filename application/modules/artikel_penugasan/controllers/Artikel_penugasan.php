...
class Artikel_penugasan extends CI_Controller
{
    var $active_menu = array(
        'active' => 'menu_artikel',
        'sub_active' => 'submenu_artikel_penugasan',
    );
    ...
    public function index()
    {
        ...
        //content
        $content['page_title'] = 'Artikel Penugasan';
        $content['content_title'] = 'Artikel Penugasan';
