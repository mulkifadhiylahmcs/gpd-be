...
class Adsd_rectangel extends CI_Controller
{
    var $active_menu = array(
        'active' => 'menu_iklan',
        'sub_active' => 'submenu_adsd_rectangel',
    );
    ...
    public function index()
    {
        ...
        //content
        $content['page_title'] = 'Iklan Desktop (RECTANGEL)';
        $content['content_title'] = 'Iklan Desktop (RECTANGEL)';
