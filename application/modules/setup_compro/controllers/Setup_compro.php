...
class Setup_compro extends CI_Controller
{
    var $active_menu = array(
        'active' => 'menu_website',
        'sub_active' => 'submenu_setup_compro',
    );
    ...
    public function index()
    {
        ...
        //content
        $content['page_title'] = 'Setup Company Profile';
        $content['content_title'] = 'Setup Company Profile';
